...
################################################################
# This is a generated script based on design: Current_response_test
#
...
# source Current_response_test_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# CurrentResponse, DivIntDelay, DivToAdrress
...
set design_name Current_response_test
...
proc create_root_design { parentCell } {
  ...
  # Create instance: DivIntDelay_0, and set properties
  set block_name DivIntDelay
  set block_cell_name DivIntDelay_0
  if { [catch {set DivIntDelay_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DivIntDelay_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {../../../../../../../../../../../../instruments/plasma-current-response/cores/current_response_v1_0/current_lut.coe} \
  ...
  connect_bd_net -net CurrentResponse_0_V_curr [get_bd_ports Current] [get_bd_pins CurrentResponse_0/V_curr]
  connect_bd_net -net DivIntDelay_0_Int_out [get_bd_pins CurrentResponse_0/Expo_int_result] [get_bd_pins DivIntDelay_0/Int_out]
  connect_bd_net -net DivToAdrress_0_BRAM_addr [get_bd_pins DivToAdrress_0/BRAM_addr] [get_bd_pins blk_mem_gen_0/addra]
  connect_bd_net -net DivToAdrress_0_divider_int_res [get_bd_pins DivIntDelay_0/Int_in] [get_bd_pins DivToAdrress_0/divider_int_res]
  connect_bd_net -net Isat_1 [get_bd_ports Isat] [get_bd_pins CurrentResponse_0/I_sat]
  connect_bd_net -net Resistence_1 [get_bd_ports Resistence] [get_bd_pins CurrentResponse_0/Resistence]
